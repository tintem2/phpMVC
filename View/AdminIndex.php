...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
		...
		<script type="text/javascript" src="assets/admin1/resources/scripts/jquery.datePicker.js"></script>
		<script type="text/javascript" src="assets/admin1/resources/scripts/jquery.date.js"></script>
		<!--[if IE]><script type="text/javascript" src="assets/admin1/resources/scripts/jquery.bgiframe.js"></script><![endif]-->
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<!-- Logo (221px wide) -->
			<a href="#"><img id="logo" src="assets/admin1/resources/images/logo.png" alt="Simpla Admin logo" /></a>
			...
			<div id="profile-links">
				...
				<br />
				<a href="index.php" title="View the Site">View the Site</a> | 
				<a href="index.php?controller=UserController&action=adminlogout" title="Sign Out">Sign Out</a>
			</div>        
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="#"><span>
					<img src="assets/admin1/resources/images/icons/pencil_48.png" alt="icon" /><br />
					Write an Article
				</span></a></li>
				
				<li><a class="shortcut-button" href="#"><span>
					<img src="assets/admin1/resources/images/icons/paper_content_pencil_48.png" alt="icon" /><br />
					Create a New Page
				</span></a></li>
				
				<li><a class="shortcut-button" href="#"><span>
					<img src="assets/admin1/resources/images/icons/image_add_48.png" alt="icon" /><br />
					Upload an Image
				</span></a></li>
				
				<li><a class="shortcut-button" href="#"><span>
					<img src="assets/admin1/resources/images/icons/clock_48.png" alt="icon" /><br />
					Add an Event
				</span></a></li>
				
				<li><a class="shortcut-button" href="#messages" rel="modal"><span>
					<img src="assets/admin1/resources/images/icons/comment_48.png" alt="icon" /><br />
					Open Modal
				</span></a></li>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img src="assets/admin1/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
							<div>
							...
							?>	
								<tr>
									...
									<td><a href="#" title="title">
										<?php echo $value['tensach'] ?></a>
									</td>
									<td>Consectetur adipiscing</td>
									<td>Donec tortor diam</td>
									<td>
										<!-- Icons -->
										 <a href="#" title="Edit"><img src="assets/admin1/resources/images/icons/pencil.png" alt="Edit" /></a>
										 <a href="#" title="Delete"><img src="assets/admin1/resources/images/icons/cross.png" alt="Delete" /></a> 
										 <a href="#" title="Edit Meta"><img src="assets/admin1/resources/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a>
									</td>
								</tr>
							<?php
						}
