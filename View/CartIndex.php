...
<body>
	...
	<div>
		<?php 
		if (isset($_SESSION['userLogin'])) //da dang nhap
		{
			?>
			<a href="index.php?controller=UserController&action=checkOut">Thanh Toan</a>
			<?php
		}
		else
		{
			?>
			<a href="index.php?controller=UserController&action=userLogin">Hay dang nhap de thanh toan</a>
			<?php
		}
		?>
	</div>
