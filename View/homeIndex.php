    	...
    	<ul>
          ...
          //  print_r($_SESSION);
            if (isset($_SESSION['userLogin']))
                {?>
                <li><a href="#">Hi,<b> <?php 
                    echo $_SESSION['userLogin']['tenkh'];
                ?></b></a></li>
                <li>
                    <a href="index.php?controller=UserController&action=doimatkhau">Doi MK</a>
                </li>

                <li><a href="index.php?controller=UserController&action=userLogout">Thoat</a></li>
            <?php 
                }
            else 
            {
                ?>
                <li><a href="index.php?controller=UserController&action=userLogin">Dang nhap</a></li>
                <li><a href="index.php?controller=UserController&action=userRegister">D Ky</a></li>
            <?php
            }
            ?>
            <li><a href="index.php?controller=CartController">Gio hang</a></li>




             <!-- <li><a href="index.php?controller=AdminController">admin</a></li> -->
    	</ul>
    </div> <!-- end of menu -->
